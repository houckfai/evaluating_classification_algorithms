...
% concatenate all analyzed BLN trials for methods project - kmeans ROIs
...
outputFile = ([baseFilePath outputFolder 'group_data_bln_byCondition_kmeans_rois_' algo '.mat']);
...
fileList = dir(fullfile(inputFilePath, sprintf('data_*_bln_%s_kmeans.mat', algo)));
...
for iFile = 1:length(fileList)
    ...
    dataLoad = load(filePath, 'kmeansData');
    ...
    for c = 1:5
        ...
        res = dataLoad.kmeansData.ConditionLevel.(condName);
...
writetable(allData, [baseFilePath outputFolder 'group_data_bln_byCondition_kmeans_rois_' algo '.xlsx']);
